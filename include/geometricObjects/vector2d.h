...
#include <ostream>
#include <istream> // Necessário para std::istream
#include <stdexcept>
#include <cmath>
#include <string>
...
public:
    ...
    // ... (Operadores matemáticos mantidos) ...
    ...
    // Operadores com escalares (mantidos) ...
    template <typename T>
...
template <typename T>
Vector2D operator*(T scalar, const Vector2D& vec) { return vec * scalar; }
